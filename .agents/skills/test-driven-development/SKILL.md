...
description: Use when writing ANY new code - features, bug fixes, refactoring, behavior changes. Enforces RED-GREEN-REFACTOR cycle. Write failing test first, watch it fail, write minimal code, watch it pass, refactor.
---
