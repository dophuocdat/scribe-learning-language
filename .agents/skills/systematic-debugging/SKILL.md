...
description: Use when debugging ANY technical issue - test failures, bugs, unexpected behavior, performance problems, build failures, integration issues. Especially when under time pressure or when previous fixes failed.
---
...
- Use **test-driven-development** skill for creating failing test case (Phase 4)
- Use **verification-before-completion** skill to verify fix worked before claiming success
