-- ============================================
-- Atomic XP & Streak functions
-- Replaces client-side read-modify-write with
-- server-side atomic operations to prevent race conditions
-- ============================================

-- Award XP atomically: increment total_xp, compute level, insert history
...
-- Update streak atomically: check date, increment or reset
